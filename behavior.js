...
function drawMars() {
  ...
  webgl_context.uniform4f(uniform_props, radians(0.0), radians(mars_y_rot), radians(0.0), 1.0);
...
function drawMGS() {
  ...
  let x = orbit_radius_crd * Math.sin(radians(orbit_speed)) * Math.cos(radians(orbit_angle_crd));
  let y = orbit_radius_crd * Math.sin(radians(orbit_speed)) * Math.sin(radians(orbit_angle_crd));
  let z = orbit_radius_crd * Math.cos(radians(orbit_speed));
